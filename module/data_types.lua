...
add("string-options", function(input, _, options)
    ...
    if option == nil then
        return invalid{"exp-commands.reject-string-options", table.concat(options, ", ")}
    else
        return valid(option)
    end
end)
...
add("string-key", function(input, _, map)
    ...
    if option == nil then
        return invalid{"exp-commands.reject-string-options", table.concat(table.get_keys(map), ", ")}
    else
        return valid(option)
    end
end)
...
add("string-max-length", function(input, _, maximum)
    if input:len() > maximum then
        return invalid{"exp-commands.reject-string-max-length", maximum}
    else
        return valid(input)
    end
end)
...
add("number", function(input)
    ...
    if number == nil then
        return invalid{"exp-commands.reject-number"}
    else
        return valid(number)
    end
end)
...
add("number-range", function(input, _, minimum, maximum)
    ...
    elseif number < minimum or number > maximum then
        return invalid{"exp-commands.reject-number-range", minimum, maximum}
    else
        return valid(number)
    end
end)
...
add("player", function(input)
    ...
    if player == nil then
        return invalid{"exp-commands.reject-player", input}
    else
        return valid(player)
    end
end)
...
add("player-online", function(input)
    ...
    elseif player.connected == false then
        return invalid{"exp-commands.reject-player-online"}
    else
        return valid(player)
    end
end)
...
add("player-online", function(input)
    ...
    elseif player.character == nil or player.character.health <= 0 then
        return invalid{"exp-commands.reject-player-alive"}
    else
        return valid(player)
    end
end)
...
add("force", function(input)
    ...
    if force == nil then
        return invalid{"exp-commands.reject-force"}
    else
        return valid(force)
    end
end)
...
add("surface", function(input)
    ...
    if surface == nil then
        return invalid{"exp-commands.reject-surface"}
    else
...
add("color", function(input)
    ...
    if color == nil then
        return invalid{"exp-commands.reject-color"}
    else
        return valid(color)
    end
end)